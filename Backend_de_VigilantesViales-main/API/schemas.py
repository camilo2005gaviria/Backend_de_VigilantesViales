...
# ──────────────────────────────────────────────────────────────
# SCHEMAS DE ESTADÍSTICAS ADICIONALES
# ──────────────────────────────────────────────────────────────
class PorDiaSemanaOut(BaseModel):
    dia: str
    total: int
    fatales: int


class TendenciaAnualOut(BaseModel):
    anio: int
    accidentes: int
    fatales: int


class PorMarcaOut(BaseModel):
    nombre_marca: str
    cantidad: int
    fatal: int


class PorAutoridadOut(BaseModel):
    nombre_autoridad: str
    accidentes: int
